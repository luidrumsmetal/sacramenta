...
class Matrimonio extends CI_Controller{
  ...
  function matrimonioRegister()
  {
    ...
    $this->form_validation->set_rules(
      'esposo', '<b>"Nombre del esposo"</b>', 
      'trim|required|xss_clean',
        array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          ));
    $this->form_validation->set_rules(
      'esposa', '<b>"Nombre de la esposa"</b>', 
      'trim|required|xss_clean',
        array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          ));    
    $this->form_validation->set_rules(
      'fechacom', '<b>"Fecha de Matrimonio"</b>', 
      'trim|required|xss_clean',
        array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          ));
    $this->form_validation->set_rules(
      'parroquia', '<b>"Parroquia de celebración"</b>', 
      'trim|required|xss_clean',
         array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          ));
    $this->form_validation->set_rules(
      'jurisdiccion', '<b>"Jurisdicción"</b>', 
      'trim|required|xss_clean',
          array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          ));
    $this->form_validation->set_rules(
      ...
      'sacerdote', '<b>"Sacerdote Celebrante"</b>',
      'trim|required|xss_clean',
          array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          )
    ...
    $this->form_validation->set_rules(
      ...
      'sacerdote1', '<b>"Sacerdote certificador"</b>',
      'trim|required|xss_clean',
          array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          ));
    ...
    $this->form_validation->set_rules(
      'oficialia', '<B>"Oficilía"</B>', 
      'trim|required|xss_clean',
          array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          ));
    $this->form_validation->set_rules(
      'partida', '<b>"Número de Partida"</b>', 
      'trim|required|xss_clean',
          array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s.</font></div>',
          ));
    $this->form_validation->set_rules(
      'numeroOf', '<B>"Número de registro civil"</B>', 
      'trim|required|xss_clean',
          array(
              'required'      => '<div align="center"><font color="FFFFFF">No ha ingresado %s de registro.</font></div>',
          ));    
          ...
          $data = array(
            ...
            if ($this->Sacrament_model->Register('certificado',$data) == TRUE) {
               ...
               $data = array(
                  ...
                  $this->session->set_flashdata('error', 'Error al editar los datos (Registro Civil)');
                  redirect(base_url().'matrimonio');
                  }

              }
              else{
              $this->session->set_flashdata('error', 'Error al editar los datos (Libro)');
              redirect(base_url().'matrimonio');
              }
      }
        else
        {
          $this->session->set_flashdata('error', 'Error al editar los datos (certificado)');
          redirect(base_url().'matrimonio');
        }
      }
      else
  ...
  function delete() {
        ...
        $this->Sacrament_model->delete($u);
            ...
            redirect(base_url() .'matrimonio/listMarried');
