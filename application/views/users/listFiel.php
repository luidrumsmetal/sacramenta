        ...
        <div class="row">
            ...
            <script type="text/javascript">
                ...
                $('#tblPersonas').DataTable({
                    ...
                    'ajax': {
                        "url":"<?php echo base_url()?>listas/getFieles",
                        "type":"POST"
                    },
                    'columns': [
                        {data: 'rownum'},
                        ...
                        {"orderable": true,
                            render: function (data, type, row) {
                                return '<span class="pull-right">' +
                                    '    <a href="<?php echo base_url();?>users/edit_fiel/'+row.rownum+'" title="Editar informacion" class="btn waves-effect waves-light amber darken-4""><i class="mdi-editor-border-color"></i></a>' +
