            ...
            <div class="col s12 m12 l12">
                ...
                <nav class="amber darken-4">
                    <div class="nav-wrapper">
                        <div class="col s12">
                            <h1 class="brand-logo center">Editar Cuenta Parroquia</h1>
                        </div>
                    </div>
                </nav>
                ...
                <div class="card-panel">
                    ...
                    <div class="row">
                        <form class="col s12" id="formPriest" method="post" action="<?php echo base_url(); ?>users/update_parroquia">

                            <div class="row">
                                <div class="input-field col s12 m6 l12">
                                    <i class="mdi-action-home prefix"></i>
                                    <input placeholder="Ingrese la parroquia" id="parroquia" name="parroquia" type="text" value="<?php echo $get->nombre?>" >
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    ...
                                    <input placeholder="Ingrese su correo electrónico" id="email" name="email" type="text" value='<?php echo $get->emailParroquia ?>'>
