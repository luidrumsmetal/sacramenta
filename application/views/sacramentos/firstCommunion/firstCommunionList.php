      ...
      <div class="row">
        ...
        <?php } ?>
          ...
          <div id="modal1" class="modal">
              <form action="<?php echo base_url(); ?>firstCommunion/delete" method="post">
                  <div class="modal-content">x
                      <h4 align="center">Eliminar Comunión</h4>
                      <input type="hidden" id="idCertificado" name="id" value="" />
                      <h6 style="text-align: center">¿Desea eliminar este registro de primera comunión?</h6>
                  </div>
