...
<script type="text/javascript">
        ...
        $('#tblPersonas').DataTable({
            ...
            'ajax': {
                "url":"<?php echo base_url()?>listas/getComunion",
                "type":"POST"
            },
            'columns': [
                {data: 'rownum'},
                ...
                {"orderable": true,
                    render: function (data, type, row) {
                       return '<span class="pull-right">' +
                        '    <a href="<?php echo base_url();?>firstCommunion/edit/'+row.rownum+'" title="Editar informacion" class="btn waves-effect waves-light amber darken-4""><i class="mdi-editor-border-color"></i></a>' +
                        '    <a href="<?php echo base_url();?>firstCommunion/delete/'+row.rownum+'"  class="btn waves-effect waves-light btn modal-trigger red darken-4" title="Eliminar"><i class="mdi-action-delete"></i></a>' +
